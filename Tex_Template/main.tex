...
% Optional:
% If you want a narrower or wider left column in the main table,
% uncomment and adjust the following line.
% \SetLeftColumnWidth{4.2cm}
...
\PlanStep{Week 3--4}
{Develop the main methodology, carry out theoretical analysis, computational experiments, or data analysis, and discuss intermediate results with the supervisor.}
